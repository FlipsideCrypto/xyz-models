...
$$
    ...
    try {
        ...
        snowflake.execute({sqlText: `GRANT USAGE ON DATABASE ${DESTINATION_DB_NAME} TO <INSERT AWS LAMBDA API ROLE HERE>`}); 
        ...
        snowflake.execute({sqlText: `GRANT USAGE ON ALL STAGES IN DATABASE ${DESTINATION_DB_NAME} TO ROLE <INSERT AWS LAMBDA API ROLE HERE>;`}); 
